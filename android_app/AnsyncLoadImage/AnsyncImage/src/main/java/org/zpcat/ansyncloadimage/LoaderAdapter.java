...
public class LoaderAdapter extends BaseAdapter {
    ...
    private ImageLoader mAsyncTaskImageLoader;


    public LoaderAdapter(Context context) {
        mContext = context;
        //mAsyncTaskImageLoader = new AsyncTaskImageLoader(context, this);
        mAsyncTaskImageLoader = new ThreadPoolImageLoader(context, this);

    }

    public ImageLoader getImageLoader() {
        return mAsyncTaskImageLoader;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mAsyncTaskImageLoader.displayImage(URLS[position], viewHolder.mImage);
        viewHolder.mText.setText("--" + position + "--");
